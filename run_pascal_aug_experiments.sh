...
REG_ICT01_CW001="--cons_weight=0.01 --ict_alpha=0.1 --conf_thresh=0.97"
REG_AUG_SEMISUP_CW0003="--cons_weight=0.003 --conf_thresh=0.97"
...
# Augmentation
python train_seg_semisup_aug_mt.py ${PARAMS_PASCALAUG_DEEPLAB2I} ${AUG_PASCAL} --n_sup=${n_sup} ${REG_AUG_SEMISUP_CW0003} --job_desc=pascalaug_deeplab2i_lr3e-5_aug_cw0.003_semisup_${n_sup_txt}_split0
# ICT
python train_seg_semisup_ict.py ${PARAMS_PASCALAUG_DEEPLAB2I} ${AUG_PASCAL} --n_sup=${n_sup} ${REG_ICT01_CW001} --job_desc=pascalaug_deeplab2i_lr3e-5_ict0.1_cw0.01_semisup_${n_sup_txt}_split0
# VAT
